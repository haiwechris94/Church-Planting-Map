 ...
 *
 * JP API docs : https://api.joshuaproject.net (v1)
...
/**
 * Map engagementStatus -> legacy status enum (for the `status` field)
 * Schema `status` enum: ['unreached','pioneer','mid-journey','tipping-point','movement']
 * Schema `engagementStatus` enum: ['unreached','pioneer','midway','tipping-point','dmm']
 */
function engagementToLegacyStatus(engagementStatus) {
  switch (engagementStatus) {
    case 'midway':        return 'mid-journey';
    case 'dmm':           return 'movement';
    case 'pioneer':       return 'pioneer';
    case 'tipping-point': return 'tipping-point';
...
function transformJPRecord(record, adminId) {
  ...
  return {
    ...
    engagementStatus,
    status:            engagementToLegacyStatus(engagementStatus),
    engagementLevel:   '',
